...
3.  find the class : UploadServlet.java
     modify the code(line 49):  File temp = new File("/home/wp/tmp/uploadfile");
     change the path  "/home/wp/tmp/uploadfile" to you local file path.
